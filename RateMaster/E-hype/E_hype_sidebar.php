...
<svg style="display:none;">
  <defs>
    ...
    <g id="item">
        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-explicit-fill" viewBox="0 0 16 16">
...
<nav class="nav__cont">
  <ul class="nav">
    <li class="nav__items ">
      ...
      <a href="E_hypebeastpage.php">Dashboard</a>
    </li>
    ...
    <li class="nav__items ">
      ...
      <a href="E_hypeRate.php">E_Hype Rate</a>
    </li>
