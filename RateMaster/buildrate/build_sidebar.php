...
<div class="sidebar" id="sidebar">
    ...
    <a href="buildratepage.php"><ion-icon name="bar-chart"></ion-icon><span class="icon-text">Dashboard</span></a>
    <a href="BuildRate.php"><ion-icon name="star"></ion-icon><span class="icon-text">Build Rate</span></a>
