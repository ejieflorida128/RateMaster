...
<div class="sidebar" id="sidebar">
    ...
    <a href="Iratepage.php"><ion-icon name="bar-chart"></ion-icon><span class="icon-text">Dashboard</span></a>
    <a href="IRate.php"><ion-icon name="star"></ion-icon><span class="icon-text">I-Rate</span></a>
